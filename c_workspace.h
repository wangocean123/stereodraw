...
namespace gis
{
	...
	class STEREODRAW_API c_workspace
	{
	public:
		c_workspace();
		virtual ~c_workspace();
		...
		void query_rect(StereoDraw::rect_3d rc, const StereoDraw::matrix4d *m, gis::const_geometry_array& arr);
		void query_nearest(StereoDraw::point_3d pt, double r, const StereoDraw::matrix4d* m, gis::const_geometry_array& arr, std::vector<double>* dis_arr = NULL);
		void query_nearest(StereoDraw::point_3d pt, StereoDraw::rect_3d rect, const StereoDraw::matrix4d* m, gis::const_geometry_array& arr, std::vector<double>* dis_arr = NULL);
